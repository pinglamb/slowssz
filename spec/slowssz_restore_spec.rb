...
RSpec.describe Slowssz do
  describe '.restore' do
    ...
    it 'VarTestStruct nil' do
      expect(Slowssz::Marshal.restore(['cdab07000000ff'].pack('H*'), VarTestContainer)).to eq(
        VarTestContainer.new(Slowssz::Uint16.new(0xabcd), nil, Slowssz::Uint8.new(0xff))
      )
    end
    ...
    it 'VarTestStruct empty' do
      expect(Slowssz::Marshal.restore(['cdab07000000ff'].pack('H*'), VarTestContainer)).to eq(
        VarTestContainer.new(
          ...
          # Empty List and nil are the same, nil preferred
    ...
    it 'VarTestStruct some' do
      expect(Slowssz::Marshal.restore(['cdab07000000ff010002000300'].pack('H*'), VarTestContainer)).to eq(
        VarTestContainer.new(
          Slowssz::Uint16.new(0xabcd),
          Slowssz::ListType
